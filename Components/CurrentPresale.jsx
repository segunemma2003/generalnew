...
const CurrentPresale = ({
  ...
  return (
    <section className={`section bg-[#e3c7b6]`}>
      <div className={`sectionContainer`}>
        <div className="flex flex-col items-center contentContainer">
          ...
          <div className="bg-white rounded-lg px-[0.8rem] py-[1rem] md:px-[1.2rem] md:py-[1.5rem] lg:px-[1.5rem] lg:py-[2rem]">
            ...
            {settings? Number(settings['amount_raised_in_usdt']): "245,353,533"}  /
              <span className="text-[#FFA800]">    {settings? Number(settings['coin']): "8000000"}Meters</span>
            </p>
            <p className="font-medium text-[1rem] md:text-[1.2rem] lg:text-[1.5rem]">
              <span className="font-bold text-[#3B2621]">Stage 1 =  {settings? Number(settings['current_percent']): "10"}%</span> of
              the Journey
            </p>
            <p className="font-medium text-[1rem] md:text-[1.2rem] lg:text-[1.5rem]">
          ...
          <p className="text-center text-[1.1rem] md:text-[1.3rem] lg:text-[1.8rem] font-semibold">
            <span className="text-[#964C1E]">USD Raised</span> ${settings? Number(settings['amount_raised_in_dollars']): "10"}
            <br />
            <span className="text-[#964C1E]">$1ETH</span> = {settings? Number(settings['price']) * 10000000: "20000"} KAI
          </p>
        </div>
      </div>
    </section>
