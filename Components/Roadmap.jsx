  ...
  return (
    <section className={`section ${styles.roadmapSection}`}>
      <div className={`sectionContainer `}>
        <div className={`contentContainer ml-0 bg-[#fff]`}>
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] md:grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6">
            {roadmap.map((item) => (
              <div
                key={``}
